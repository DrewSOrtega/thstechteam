...
<div class="maint">
	...
	<ul class="ogpclist">
		<li>OGPC 1.0 = Science Behind Energy Issues</li>
		<li></br></li>
		<li>OGPC 2.0 = Water Treatment</li>
		<li></br></li>
		<li>OGPC 3.0 = Human Health</li>
		<li></br></li>
		<li>OGPC 4.0 = Disaster Relief and Recovery</li>
		<li></br></li>
		<li>OGPC 5.0 = Urban Planning</li>
		<li></br></li>
		<li>OGPC 6.0 = The "Social Good"</li>
		<li></br></li>
